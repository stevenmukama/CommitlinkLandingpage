...
function Footer() {
  ...
  return (
    <>
      <footer className="pt-10 bg-[#012825]">
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
          <div className="justify-between items-center gap-12 md:flex">
            ...
            <div className="flex-1 mt-6 md:mt-0">
              <form
                ...
                <button className="block w-auto py-3 px-4 font-medium text-sm text-center hover:text-black text-white bg-[#daa51b] hover:bg-[#cbe99a] active:bg-[#cbe99a] active:shadow-none rounded-lg shadow">
                  Subscribe
                </button>
              </form>
            </div>
          ...
          <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
            <p className="text-gray-300">
              © 2024 CommitLink Inc. All rights reserved.
            </p>
            <div className="flex items-center gap-x-6 text-gray-400 mt-6">
              ...
              <a href="#">
                <svg
                  ...
                  fill="none"
                  viewBox="0 0 48 48">
                  <g fill="currentColor" clipPath="url(#)">
                    <path
                      fillRule="evenodd"
